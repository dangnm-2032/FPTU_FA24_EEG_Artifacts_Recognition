...
##################### MODEL ###############################################
model = load_model(r'.\pipeline_right\checkpoints\checkpoint.keras')
###########################################################################


##################### SCALER ##############################################
import joblib
scaler = joblib.load(r'.\pipeline_right\checkpoints\scaler.save')  
###########################################################################
...
while True:
    ...
    ########################### Preprocessing ###################################
    x = pipeline(eeg_data, filter_right, scaler)
